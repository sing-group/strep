...
-- Insert here the default users, roles, etc.
 ...
 insert into dataset (name, author, description, pipeline, doi, access, language, type, upload_date, spam_percentage, ham_percentage) values("systemdataset1", "Yo", "Este es un dataset de prueba para mostrar en los datasets publicos","dfagergvrad", "dfgaerdgbvtrzd", "protected", "spanish", "systemdataset", '1000-01-01 00:00:00', 30, 70);
 ...
 insert into dataset (name, author, description, pipeline, doi, access, language, type, upload_date, spam_percentage, ham_percentage) values("systemdataset3", "Yo", "Este es un dataset de prueba para mostrar en los datasets publicos","dfagergvrad", "dfgaerdgbvtrzd", "protected", "spanish", "systemdataset", '1000-01-01 00:00:00', 30, 70);
